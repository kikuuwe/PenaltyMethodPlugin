...
PMCFSImpl::PMCFSImpl(WorldBase& world) :
    world(world),
...
void PMCFSImpl::initBody(const DyBodyPtr& body, BodyData& bodyData)
{
...
void PMCFSImpl::initExtraJoints(int bodyIndex)
{
...
void PMCFSImpl::init2Dconstraint(int bodyIndex)
{
...
void PMCFSImpl::initialize(void)
{
...
inline void PMCFSImpl::clearExternalForces()
{
...
void PMCFSImpl::setConstraintPoints()
{
    collisionDetector->detectCollisions(boost::bind(&PMCFSImpl::extractConstraintPoints, this, _1));
...
void PMCFSImpl::extractConstraintPoints(const CollisionPair& collisionPair)
{
    LinkPair* pLinkPair;
...
*/
bool PMCFSImpl::setContactConstraintPoint(LinkPair& linkPair, const Collision& collision)
{
...
void PMCFSImpl::setFrictionVectors(ConstraintPoint& contact)
{
    Vector3 u = Vector3::Zero();
    int minAxis = 0;
...
void PMCFSImpl::setExtraJointConstraintPoints(const ExtraJointLinkPairPtr& linkPair)
{
    ConstraintPointArray& constraintPoints = linkPair->constraintPoints;
...
void PMCFSImpl::set2dConstraintPoints(const Constrain2dLinkPairPtr& linkPair)
{
...
void PMCFSImpl::putContactPoints()
{
    os << "Contact Points\n";
...
void PMCFSImpl::solveImpactConstraints()
{
    if(CFS_DEBUG){
        os << "Impacts !" << std::endl;
    }
...
void PMCFSImpl::setAccelCalcSkipInformation()
{
...
void PMCFSImpl::setDefaultAccelerationVector()
{
...
void PMCFSImpl::setAccelerationMatrix()
{
    const int n = globalNumConstraintVectors;
    const int m = globalNumFrictionVectors;
...
void PMCFSImpl::initABMForceElementsWithNoExtForce(BodyData& bodyData)
{
...
void PMCFSImpl::calcABMForceElementsWithTestForce
...
void PMCFSImpl::calcAccelsABM(BodyData& bodyData, int constraintIndex)
{
    std::vector<LinkData>& linksData = bodyData.linksData;
...
void PMCFSImpl::calcAccelsMM(BodyData& bodyData, int constraintIndex)
{
    std::vector<LinkData>& linksData = bodyData.linksData;
...
void PMCFSImpl::extractRelAccelsOfConstraintPoints
(Eigen::Block<MatrixX>& Kxn, Eigen::Block<MatrixX>& Kxt, int testForceIndex, int constraintIndex)
{
...
void PMCFSImpl::extractRelAccelsFromLinkPairCase1
...
void PMCFSImpl::extractRelAccelsFromLinkPairCase2
(Eigen::Block<MatrixX>& Kxn, Eigen::Block<MatrixX>& Kxt,
...
void PMCFSImpl::copySymmetricElementsOfAccelerationMatrix
(Eigen::Block<MatrixX>& Knn, Eigen::Block<MatrixX>& Ktn, Eigen::Block<MatrixX>& Knt, Eigen::Block<MatrixX>& Ktt)
{
...
void PMCFSImpl::clearSingularPointConstraintsOfClosedLoopConnections()
{
...
void PMCFSImpl::setConstantVectorAndMuBlock()
{
...
void PMCFSImpl::addConstraintForceToLinks()
{
...
void PMCFSImpl::solveMCPByProjectedGaussSeidelMainStep(const MatrixX& M, const VectorX& b, VectorX& x)
{
...
void PMCFSImpl::solveMCPByProjectedGaussSeidelInitial
(const MatrixX& M, const VectorX& b, VectorX& x, const int numIteration)
{
    const int size = globalNumConstraintVectors + globalNumFrictionVectors;
...
void PMCFSImpl::checkLCPResult(MatrixX& M, VectorX& b, VectorX& x)
{
    os << "check LCP result\n";
    os << "-------------------------------\n";
...
void PMCFSImpl::checkMCPResult(MatrixX& M, VectorX& b, VectorX& x)
{
    os << "check MCP result\n";
    os << "-------------------------------\n";
...
void PMConstraintForceSolver::setCollisionDetector(CollisionDetectorPtr detector)
{
    impl->collisionDetector = detector;
}


CollisionDetectorPtr PMConstraintForceSolver::collisionDetector()
{
    return impl->collisionDetector;
}


void PMConstraintForceSolver::setFriction(double staticFriction, double slipFliction)
{
...
double PMConstraintForceSolver::staticFriction() const
{
    return impl->defaultStaticFriction;
}


double PMConstraintForceSolver::slipFriction() const
{
    return impl->defaultSlipFriction;
}


void PMConstraintForceSolver::setContactCullingDistance(double distance)
{
    impl->defaultContactCullingDistance = distance;
}


double PMConstraintForceSolver::contactCullingDistance() const
{
    return impl->defaultContactCullingDistance;
}


void PMConstraintForceSolver::setContactCullingDepth(double depth)
{
    impl->defaultContactCullingDepth = depth;
}


double PMConstraintForceSolver::contactCullingDepth()
{
    return impl->defaultContactCullingDepth;
}


void PMConstraintForceSolver::setCoefficientOfRestitution(double epsilon)
{
    impl->defaultCoefficientOfRestitution = epsilon;
}


double PMConstraintForceSolver::coefficientOfRestitution() const
{
    return impl->defaultCoefficientOfRestitution;
}


void PMConstraintForceSolver::setGaussSeidelErrorCriterion(double e)
{
    impl->gaussSeidelErrorCriterion = e;
}


double PMConstraintForceSolver::gaussSeidelErrorCriterion()
{
    return impl->gaussSeidelErrorCriterion;
}


void PMConstraintForceSolver::setGaussSeidelMaxNumIterations(int n)
{
    impl->maxNumGaussSeidelIteration = n;
}


int PMConstraintForceSolver::gaussSeidelMaxNumIterations()
{
    return impl->maxNumGaussSeidelIteration;
}


void PMConstraintForceSolver::setContactDepthCorrection(double depth, double velocityRatio)
{
...
double PMConstraintForceSolver::contactCorrectionVelocityRatio()
{
    return impl->contactCorrectionVelocityRatio;
}


void PMConstraintForceSolver::enableConstraintForceOutput(bool on)
{
    impl->isConstraintForceOutputMode = on;
}


void PMConstraintForceSolver::set2Dmode(bool on)
{
    impl->is2Dmode = on;
}


void PMConstraintForceSolver::initialize(void)
{
    impl->initialize();
}


void PMConstraintForceSolver::solve()
{
    impl->solve();
}


void PMConstraintForceSolver::clearExternalForces()
{
